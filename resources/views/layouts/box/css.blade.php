...
<!-- Font Awesome-->
<link rel="stylesheet" type="text/css" href="{{route('/')}}/assets/css/fontawesome.css">
<!-- ico-font-->
<link rel="stylesheet" type="text/css" href="{{route('/')}}/assets/css/icofont.css">
<!-- Themify icon-->
...
@yield('css')
<!-- Plugins css Ends-->
<link rel="stylesheet" type="text/css" href="{{route('/')}}/assets/css/pe7-icon.css">
<!-- Bootstrap css-->
<link rel="stylesheet" type="text/css" href="{{route('/')}}/assets/css/bootstrap.css">
<!-- App css-->
<link rel="stylesheet" type="text/css" href="{{route('/')}}/assets/css/style.css">
