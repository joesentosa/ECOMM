      ...
      <ul class="iconMenu-bar custom-scrollbar">
         <li>
            <a class="bar-icons" href="#">
               <!--img(src='{{route('/')}}/assets/images/menu/home.png' alt='')--><i class="pe-7s-home"></i><span>General    </span>
            </a>
            <ul class="iconbar-mainmenu custom-scrollbar">
               <li class="iconbar-header">Dashboard</li>
               <li><a href="{{route('light-layout-box')}}">Default</a></li>
         ...
         <li>
            <a class="bar-icons" href="#"><i class="pe-7s-portfolio"></i><span>UI Kits</span></a>
            <ul class="iconbar-mainmenu custom-scrollbar">
         ...
         <li>
            <span class="badge badge-pill badge-danger">Hot</span><a class="bar-icons" href="#"><i class="pe-7s-diamond"></i><span>Perk UI</span></a>
            <ul class="iconbar-mainmenu custom-scrollbar">
