...
<html lang="en">
  ...
  <body class="dark-only" main-theme-layout="box-layout">
    ...
    <div class="page-wrapper">
      <!-- Page Header Start-->
      @include('layouts.dark-box.header')
      <!-- Page Header Ends -->
      <!-- Page Body Start-->
      <div class="page-body-wrapper">
        <!-- Page Sidebar Start-->
        @include('layouts.dark-box.sidebar')
        <!-- Page Sidebar Ends-->
        <!-- Right sidebar Start-->
        @include('layouts.box.chat_sidebar')
        <!-- Right sidebar Ends-->
        <div class="page-body">
        ...
        <!-- footer start-->
        @include('layouts.dark-box.footer')
      </div>
    </div>
    @include('layouts.dark-box.script')
  </body>
</html>
