   ...
   <nav id="main-nav">
      ...
      <ul class="sm pixelstrap" id="main-menu">
         ...
         <li>
            ...
            <ul>
               <li><a href="{{route('vertical-layout-box')}}">Default</a></li>
         ...
         <li>
            ...
            <ul>
               ...
               <li>
                  ...
                  <ul class="sidebar-submenu">
                     <li>
                        <a href="flag-icon.html">Form Controls</a>
                        <ul class="sidebar-submenu">
                     ...
                     <li>
                        <a href="font-awesome.html">Form Widgets</a>
                        <ul class="sidebar-submenu">
                     ...
                     <li>
                        <a href="font-awesome.html">Form Layout</a>
                        <ul class="sidebar-submenu">
