<div class="iconsidebar-menu">
   <div class="sidebar">
      <ul class="iconMenu-bar custom-scrollbar">
         <li>
            <a class="bar-icons" href="#"><i class="pe-7s-home"></i></a>
            <ul class="iconbar-mainmenu custom-scrollbar">
               <li class="iconbar-header">Dashboard</li>
               <li><a href="{{route('default')}}">Default</a></li>
               <li><a href="{{route('crypto')}}">Crypto</a></li>
               <li><a href="dashboard-crm.html">Project</a></li>
         ...
         <li>
            <a class="bar-icons" href="#"><i class="pe-7s-box2"></i></a>
            <ul class="iconbar-mainmenu custom-scrollbar">
               ...
               <li><a href="{{route('simple-line-icon')}}">Simple line Icon</a></li>
               <li><a href="{{route('material-design-icon')}}">Material Design Icon</a></li>
               <li><a href="{{route('pe7-icon')}}">pe7 icon</a></li>
               <li><a href="{{route('typicons-icon')}}">Typicons icon</a></li>
               <li><a href="{{route('ionic-icon')}}">Ionic icon</a></li>
               <li class="iconbar-header sub-header">Animation</li>
         ...
         <li>
            <a class="bar-icons" href="#"><i class="pe-7s-note"></i></a>
            <ul class="iconbar-mainmenu custom-scrollbar">
               <li class="iconbar-header">Builders</li>
         ...
         <li>
            <a class="bar-icons" href="#"><i class="pe-7s-note2"></i></a>
            <ul class="iconbar-mainmenu custom-scrollbar">
               <li class="iconbar-header">Buttons</li>
               <li><a href="{{route('buttons')}}">Default Style</a></li>
               <li class="iconbar-header sub-header">Form Controls</li>
         ...
         <li>
            <a class="bar-icons" href="#"><i class="pe-7s-menu"></i></a>
            <ul class="iconbar-mainmenu custom-scrollbar">
         ...
         <li>
            <a class="bar-icons" href="#"><i class="pe-7s-edit"></i></a>
            <ul class="iconbar-mainmenu custom-scrollbar">
               <li class="iconbar-header">Timeline</li>
         ...
         <li>
            <a class="bar-icons" href="#"><i class="pe-7s-graph3"></i></a>
            <ul class="iconbar-mainmenu custom-scrollbar">
         ...
         <li>
            <a class="bar-icons" href="#"><i class="pe-7s-users"></i></a>
            <ul class="iconbar-mainmenu custom-scrollbar">
               <li class="iconbar-header">Apps</li>
               ...
               <li class="iconbar-header sub-header">Ecommerce</li>
         ...
         <li>
            <a class="bar-icons" href="#"><i class="pe-7s-news-paper"></i></a>
            <ul class="iconbar-mainmenu custom-scrollbar">
               ...
               <li class="iconbar-header sub-header">Authentication</li>
               ...
               <li class="iconbar-header sub-header">Coming Soon</li>
         ...
         <li>
            <a class="bar-icons" href="#"><i class="pe-7s-server"></i></a>
            <ul class="iconbar-mainmenu custom-scrollbar">
               <li class="iconbar-header">Others</li>
