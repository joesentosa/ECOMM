...
@section('breadcrumb-title')
	<h2>API<span>DataTables</span></h2>
@endsection
      ...
      <div class="col-sm-12">
         <div class="card">
            <div class="card-header">
               <h5>Add rows </h5>
               <span>New rows can be added to a DataTable using the<code class="api" title="DataTables API method">row.add()</code> API method. Simply call the API function with the data for the new row (be it an array or object). Multiple rows
      ...
      <div class="col-sm-12">
         <div class="card">
            <div class="card-header">
               ...
               <span>The DataTables API has a number of methods for attaching child rows to a parent row in the DataTable. This can be used to show additional information about a row, useful for cases where you wish to convey more information about a row than there is space for in the host table.</span>
            </div>
            <div class="card-body">
               <div class="table-responsive">
      ...
      <div class="col-sm-12">
         <div class="card">
            <div class="card-header">
               ...
               <span>This example shows how you can make use of the <code class="api" title="DataTables API method">column().visible() </code> API method to dynamically show and hide columns in a table. Also included here is scrolling, just to show it enabled with this API method, although that is not required for the API function to work.</span>
            </div>
            <div class="card-body">
               <div class="table-responsive">
