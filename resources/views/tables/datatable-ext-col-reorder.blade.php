...
@section('breadcrumb-title')
	<h2>Columns<span>Reorder</span></h2>
@endsection
      ...
      <div class="col-sm-12">
         <div class="card">
            <div class="card-header">
               ...
               <span>This example shows the basic use case of the ColReorder plugin. With ColReorder enabled for a table, the user has the ability to click and drag any table header cell, and drop it where they wish the column to be inserted. The insert point is shown visually, and the column reordering is done as soon as the mouse button is released. ColReorder is added to a DataTable through the R character added to the dom.</span>
            </div>
            <div class="card-body">
               <div class="dt-ext table-responsive">
                  <table class="display" id="basic-colreorder">
                     <thead>
                        <tr>
                           <th>Name</th>
                           <th>Position</th>
