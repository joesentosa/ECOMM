      ...
      <ul class="iconMenu-bar custom-scrollbar">
         <li>
            <a class="bar-icons" href="#">
               <i class="pe-7s-joy"></i><span>Master Barang</span>
            </a>
         ...
         <li>
            <a class="bar-icons" href="#">
               <i class="pe-7s-users"></i><span>Master User</span>
            </a>
            <ul class="iconbar-mainmenu custom-scrollbar">
         ...
         <li>
            <a class="bar-icons" href="#">
               <i class="pe-7s-cart"></i><span>Master Order</span>
            </a>
            <ul class="iconbar-mainmenu custom-scrollbar">
         ...
         <li>
            ...
            <ul class="iconbar-mainmenu custom-scrollbar">
               ...
               <li><a href="{{route('page.laporan_perbulan.admin')}}">Pendapatan per Bulan</a></li>
               <li><a href="{{route('page.laporan_invoice.admin')}}">Invoice</a></li>
               <li><a href="{{route('page.laporan_BarangLaris.admin')}}">Barang Terlaris</a></li>
            </ul>
         </li>
      </ul>
   </div>
