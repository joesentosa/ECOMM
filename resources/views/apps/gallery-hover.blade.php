...
@section('breadcrumb-title')
    <h2>Image<span>Hover Effects</span></h2>
@endsection
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="row my-gallery gallery" id="aniimated-thumbnials1" itemscope="">
                            <figure class="col-md-3 col-6 img-hover hover-2" itemprop="associatedMedia" itemscope="">
                                <a href="{{asset('assets/images/big-lightgallry/08.jpg')}}" itemprop="contentUrl"
                                   data-size="1600x950">
                                    <div><img src="{{asset('assets/images/lightgallry/08.jpg')}}" itemprop="thumbnail"
                                              alt="Image description"></div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="row gallery my-gallery" id="aniimated-thumbnials2" itemscope="">
                            <figure class="col-md-3 col-6 img-hover hover-3" itemprop="associatedMedia" itemscope="">
                                <a href="{{asset('assets/images/big-lightgallry/08.jpg')}}" itemprop="contentUrl"
                                   data-size="1600x950">
                                    <div><img src="{{asset('assets/images/lightgallry/08.jpg')}}" itemprop="thumbnail"
                                              alt="Image description"></div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="row gallery my-gallery" id="aniimated-thumbnials4" itemscope="">
                            <figure class="col-md-3 col-6 img-hover hover-5" itemprop="associatedMedia" itemscope="">
                                <a href="{{asset('assets/images/big-lightgallry/08.jpg')}}" itemprop="contentUrl"
                                   data-size="1600x950">
                                    <div><img src="{{asset('assets/images/lightgallry/08.jpg')}}" itemprop="thumbnail"
                                              alt="Image description"></div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="row gallery my-gallery" id="aniimated-thumbnials5" itemscope="">
                            <figure class="col-md-3 col-6 img-hover hover-6" itemprop="associatedMedia" itemscope="">
                                <a href="{{asset('assets/images/big-lightgallry/08.jpg')}}" itemprop="contentUrl"
                                   data-size="1600x950">
                                    <div><img src="{{asset('assets/images/lightgallry/08.jpg')}}" itemprop="thumbnail"
                                              alt="Image description"></div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="row gallery my-gallery" id="aniimated-thumbnials6" itemscope="">
                            <figure class="col-md-3 col-6 img-hover hover-7" itemprop="associatedMedia" itemscope="">
                                <a href="{{asset('assets/images/big-lightgallry/08.jpg')}}" itemprop="contentUrl"
                                   data-size="1600x950">
                                    <div><img src="{{asset('assets/images/lightgallry/08.jpg')}}" itemprop="thumbnail"
                                              alt="Image description"></div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="row gallery my-gallery" id="aniimated-thumbnials7" itemscope="">
                            <figure class="col-md-3 col-6 img-hover hover-8" itemprop="associatedMedia" itemscope="">
                                <a href="{{asset('assets/images/big-lightgallry/08.jpg')}}" itemprop="contentUrl"
                                   data-size="1600x950">
                                    <div><img src="{{asset('assets/images/lightgallry/08.jpg')}}" itemprop="thumbnail"
                                              alt="Image description"></div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="row gallery my-gallery" id="aniimated-thumbnials8" itemscope="">
                            <figure class="col-md-3 col-6 img-hover hover-9" itemprop="associatedMedia" itemscope="">
                                <a href="{{asset('assets/images/big-lightgallry/08.jpg')}}" itemprop="contentUrl"
                                   data-size="1600x950">
                                    <div><img src="{{asset('assets/images/lightgallry/08.jpg')}}" itemprop="thumbnail"
                                              alt="Image description"></div>
