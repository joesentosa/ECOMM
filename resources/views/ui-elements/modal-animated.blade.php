...
@section('breadcrumb-title')
	<h2>Animated<span>Modal</span></h2>
@endsection
            ...
            <div class="card-body">
               <div class="row">
                  ...
                  <div class="col-md-12 text-center">
                     <form class="form-inline theme-form row justify-content-center animated-modal">
                        <div class="form-group mr-4 mb-0 animated-modal-md-mb">
                           <label class="mr-3">Entrances</label>
                        ...
                        <div class="form-group mb-0 mr-0">
                           <button class="btn btn-primary btn-lg btn-pill" type="button" data-toggle="modal" data-target="#myModal">Launch demo modal</button>
                        </div>
                     </form>
                  </div>
               </div>
