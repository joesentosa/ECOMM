...
@section('breadcrumb-title')
	<h2>Bootstrap<span>Notify</span></h2>
@endsection
                     ...
                     <div class="form-group">
                        <div class="row">
                           ...
                           <div class="col-xl-4 col-sm-12 col-md-12 mb-4">
                              <select class="form-control" id="bootstrap-notify-placement-from">
                                 <option value="top">Top</option>
                                 <option value="bottom">Bottom</option>
                              </select>
                           </div>
                           <div class="col-xl-4 col-md-12 col-sm-12 mb-4">
                              <select class="form-control" id="bootstrap-notify-placement-align">
                        ...
                        <div class="row">
                           ...
                           <div class="col-xl-4 col-md-12 col-sm-12 mb-4">
                              <select class="form-control" id="bootstrap-notify-enter">
                           ...
                           <div class="col-xl-4 col-md-12 col-sm-12 mb-4">
                              <select class="form-control" id="bootstrap-notify-exit">
                                 <optgroup label="Attention Seekers">
                                    <option value="bounce">bounce</option>
                                    <option value="flash">flash</option>
                                    <option value="pulse">pulse</option>
                        ...
                        <div class="row">
                           ...
                           <div class="col-xl-4 col-md-12 col-sm-12 mb-4">
                              <select class="form-control" id="bootstrap-notify-icon">
                  ...
                  <div class="row">
                     <div class="col-xl-6">
                        <div class="form-group row">
                           ...
                           <div class="col-sm-8 col-6">
                              <div class="media-body text-left icon-state">
                                 <label class="switch">
                                 <input id="bootstrap-notify-url" type="checkbox"><span class="switch-state"></span>
                                 </label>
                              </div>
                           </div>
                        </div>
                        <div class="form-group row">
                           ...
                           <div class="col-sm-8 col-6">
                              <div class="media-body text-left icon-state">
                                 <label class="switch">
                                 <input id="bootstrap-notify-dismiss" type="checkbox"><span class="switch-state"></span>
                                 </label>
                              </div>
                           </div>
                        </div>
                        <div class="form-group row">
                           ...
                           <div class="col-sm-8 col-6">
                              <div class="media-body text-left icon-state">
                                 <label class="switch">
                                 <input id="bootstrap-notify-pause" type="checkbox"><span class="switch-state"></span>
                                 </label>
                              </div>
                           </div>
                        </div>
                        <div class="form-group row">
                           ...
                           <div class="col-sm-8 col-6">
                              <div class="media-body text-left icon-state">
                                 <label class="switch">
                                 <input id="bootstrap-notify-top" type="checkbox"><span class="switch-state"></span>
                                 </label>
                              </div>
                           </div>
                        </div>
                        <div class="form-group row">
                           ...
                           <div class="col-sm-8 col-6">
                              <div class="media-body text-left icon-state">
                                 <label class="switch">
                                 <input id="bootstrap-notify-title" type="checkbox"><span class="switch-state"></span>
                                 </label>
                              </div>
                           </div>
                        </div>
                        <div class="form-group row">
                           ...
                           <div class="col-sm-8 col-6">
                              <div class="media-body text-left icon-state">
                                 <label class="switch">
                                 <input id="bootstrap-notify-progress" type="checkbox"><span class="switch-state"></span>
                                 </label>
                              </div>
                           </div>
                        </div>
                     ...
                     <div class="col-xl-6 theme-form sm-form">
                        ...
                        <div class="form-group row">
                           ...
                           <div class="col-lg-4 col-md-9 col-sm-12">
                              <select class="form-control height-35" id="bootstrap-notify-state">
