    ...
    <div class="container-fluid">
        <div class="edit-profile">
            <div class="row">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form class="theme-form">
                                <div class="row mb-2">
                                    <div class="col">
                                        <h3 class="mb-1">{{$customer->firstname}}</h3>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="email" placeholder="{{$customer->email}}">
                                </div>
                                <div class="form-group">
                                    <label class="form-label">Password</label>
                                    <input class="form-control" type="password" value="password" readonly>
                                </div>
                ...
                <div class="col-lg-8">
                    <form class="card theme-form" action="{{url('user/profile/doUpdate')}}" method="post"> @csrf
                        <div class="card-header">
                            ...
                            <div class="row">
                                <div class="col-sm-6 col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text" placeholder="{{$customer->username}}"
                                               readonly>
                                    </div>
                                </div>
                                <div class="col-sm-6 col-md-6">
                                ...
                                <div class="col-sm-6 col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text" value="{{$customer->kota}}"
                                               placeholder="City" name="kota">
                                    </div>
                                </div>
                                <div class="col-sm-6 col-md-3">
                                    <div class="form-group">
                                        <label class="form-label">Postal Code</label>
                                        <input class="form-control" type="number" value="{{$customer->kodeZip}}"
                                               placeholder="Zip Code" name="kodeZip">
                                    </div>
                                </div>
                                <div class="col-md-5">
                                    <div class="form-group">
