                        ...
                        <div class="coupon_code right">
                            ...
                            <div class="coupon_inner">
                                ...
                                <div class="d-flex justify-content-end">
                                    <button type="button" id="edit-shipping" data-bs-toggle="modal" data-bs-target="#form_shipping">Calculate shipping</button>
                                </div>                                
                    ...
                    <form method="post" action="">  
                        <div class="row">
                            <div class="col-12">
                                <div class="row">
                                    <label>Kurir</label>
                                    <select class="form-select" aria-label="Default select example" name="cb_pilih_kurir" id="cb_pilih_kurir">
                            ...
                            <div class="col-12">
                                <div class="row">
                                    <label>Kota</label>
                                    <select class="form-select" aria-label="Default select example" name="cb_pilih_city" id="cb_pilih_city">
                            ...
                            <div class="col-12">
                                <div class="row">
                                    ...
                                    <select class="form-select" aria-label="Default select example" name="cb_pilih_provinsi" id="cb_pilih_provinsi">
                            ...
                            <div class="col-12">
                                <div class="row">
                                    ...
                                    <select class="form-select" aria-label="Default select example" name="cb_pilih_layanan" id="cb_pilih_layanan">
