                           ...
                           <div class="card-body faq-body">
                              ...
                              <div class="navigation-option">
                                 <ul>
                                    ...
                                    <li><a href="#"><i data-feather="file-text"></i>Articles</a><span class="badge badge-primary badge-pill pull-right">42</span></li>
                                    <li><a href="#"><i data-feather="youtube"></i>Video Tutorials</a><span class="badge badge-primary badge-pill pull-right">648</span></li>
            ...
            <div class="row">
               <div class="col-xl-3 xl-50 col-md-6">
                  <div class="card features-faq product-box">
                     ...
                     <div class="card-footer"><span>Dec 15, 2021</span><span class="pull-right"><i class="fa fa-star font-primary"></i><i class="fa fa-star font-primary"></i><i class="fa fa-star font-primary"></i><i class="fa fa-star font-primary"></i><i class="fa fa-star font-primary"></i></span></div>
                  </div>
               </div>
               <div class="col-xl-3 xl-50 col-md-6">
                  <div class="card features-faq product-box">
                     ...
                     <div class="card-footer"><span>Dec 15, 2021</span><span class="pull-right"><i class="fa fa-star font-primary"></i><i class="fa fa-star font-primary"></i><i class="fa fa-star font-primary"></i><i class="fa fa-star font-primary"></i><i class="fa fa-star-o font-primary"></i></span></div>
                  </div>
               </div>
               <div class="col-xl-3 xl-50 col-md-6">
                  <div class="card features-faq product-box">
               ...
               <div class="col-xl-3 xl-50 col-md-6">
                  <div class="card features-faq product-box">
                     ...
                     <div class="card-footer"><span>Dec 15, 2021</span><span class="pull-right"><i class="fa fa-star font-primary"></i><i class="fa fa-star font-primary"></i><i class="fa fa-star font-primary"></i><i class="fa fa-star font-primary"></i><i class="fa fa-star-half-o font-primary"></i></span></div>
                  </div>
               </div>
            </div>
         </div>
