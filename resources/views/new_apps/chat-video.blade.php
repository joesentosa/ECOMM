...
@section('breadcrumb-title')
	<h2>Video<span>Chat</span></h2>
@endsection

@section('breadcrumb-items')
	<li class="breadcrumb-item">Apps</li>
    <li class="breadcrumb-item">User</li>
	<li class="breadcrumb-item active">Video Chart</li>
@endsection
                                 ...
                                 <div>
                                    ...
                                    <div class="call-icons">
                                       <ul class="list-inline">
                                          <li class="list-inline-item"><a href="#"><i class="icon-video-camera"></i></a></li>
                                          <li class="list-inline-item"><a href="#"><i class="icon-volume"></i></a></li>
                                          <li class="list-inline-item"><a href="#"><i class="icon-user"></i></a></li>
                                       </ul>
                                    </div>
                                    <button class="btn btn-danger-gradien btn-block btn-lg btn-pill">END CALL</button>
                                    <div class="receiver-img"><img src="../assets/images/other-images/receiver-img.jpg" alt=""></div>
                                 </div>
                              </div>
                              <div class="col-sm-7 pl-0 caller-img"><img class="img-fluid" src="../assets/images/other-images/caller.jpg" alt=""></div>
                           </div>
                        </div>
                        <!-- chat-history ends-->
                        <!-- chat end-->
                        ...
                        <div class="tab-pane fade show active" id="info-home" role="tabpanel" aria-labelledby="info-home-tab">
                           <div class="people-list">
                              <ul class="list digits">
                                 ...
                                 <li class="clearfix">
                                    <img class="rounded-circle user-image mt-0" src="../assets/images/user/1.jpg" alt="">
                                    <div class="about">
                                       <div class="name">Vincent Porter</div>
