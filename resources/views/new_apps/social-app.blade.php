                                 ...
                                 <div class="card-body socialprofile filter-cards-view">
                                    ...
                                    <div class="customers text-center social-group">
                                       <ul>
                                          ...
                                          <li class="d-inline-block"><img class="img-40 rounded-circle" src="{{asset('assets/images/user/2.png')}}" alt="" data-container="body" data-toggle="popover" data-placement="top" title="" data-original-title="Bucky Barnes"></li>
                                          ...
                                          <li class="d-inline-block"><img class="img-40 rounded-circle" src="{{asset('assets/images/user/11.png')}}" alt="" data-container="body" data-toggle="popover" data-placement="top" title="" data-original-title="Comeren Diaz"></li>
                                       </ul>
                                    </div>
                                 </div>
                              </div>
                              ...
                              <div class="collapse show" id="collapseicon4" data-parent="#accordion" aria-labelledby="collapseicon4">
                                 <div class="card-body photos filter-cards-view">
                                    <ul class="text-center">
                                       ...
                                       <li>
                                          <div class="latest-post"><img class="img-fluid" alt="" src="{{asset('assets/images/social-app/post-9.png')}}"></div>
                                       </li>
                                    </ul>
                                 </div>
                              </div>
                        ...
                        <div class="card">
                           ...
                           <div class="card-body avatar-showcase">
                              <div class="pepole-knows">
                                 <ul>
                                    <li>
                                       <div class="add-friend text-center"><img class="img-60 img-fluid rounded-circle" alt="" src="{{asset('assets/images/user/2.png')}}"><span class="d-block f-w-600">Jason Borne</span>
                                          <button class="btn btn-primary btn-xs">Add Friend</button>
                                       </div>
                                    </li>
                                    <li>
                                       <div class="add-friend text-center"><img class="img-60 img-fluid rounded-circle" alt="" src="{{asset('assets/images/user/3.png')}}"><span class="d-block f-w-600">Anna Mull</span>
                                          <button class="btn btn-primary btn-xs">Add Friend</button>
                                       </div>
                                    </li>
                                    <li>
                                    ...
                                    <li>
                                       <div class="add-friend text-center"><img class="img-60 img-fluid rounded-circle" alt="" src="{{asset('assets/images/user/14.png')}}"><span class="d-block f-w-600">Karlene Lex</span>
                                          <button class="btn btn-primary btn-xs">Add Friend</button>
                                       </div>
                                    </li>
                                 </ul>
