...
@section('breadcrumb-title')
	<h2>Button<span>Builder</span></h2>
@endsection
                     ...
                     <div class="col-md-6 col-lg-7 order-2 order-xl-1">
                        <div class="form-horizontal generator theme-form">
                           ...
                           <div class="form-group row">
                              ...
                              <div class="col-lg-9">
                                 <div class="element-type grp-btns" data-toggle="buttons">
                        ...
                        <div class="form-group row">
                           ...
                           <div class="col-lg-9">
                              <div class="button-size grp-btns" data-toggle="buttons">
                                 <label class="btn btn-light active">
                                 ...
                                 <label class="btn btn-light">
                                 <input type="radio" name="size" value="btn-sm"> Mini
                                 </label>
                              </div>
                           </div>
                        </div>
                        <div class="form-group row">
                           ...
                           <div class="col-lg-9">
                              <div class="button-color-option">
                                 <label class="mr-3">
                                 <input type="radio" name="color-option" checked="checked" value="bootstrap"> Bootstrap Inbuilt
                                 </label>
                                 <label>
                                 <input type="radio" name="color-option" value="custom"> Custom
                                 </label>
                              </div>
                           </div>
                        </div>
                        <div class="bootstrap-inbuilt-style">
                           <div class="form-group row">
                              ...
                              <div class="col-lg-9">
                                 <div class="button-color grp-btns" data-toggle="buttons">
                                    ...
                                    <input type="radio" name="color" value="btn btn-secondary"> Seconadary
                                    </label>
                                    ...
                                    <label class="btn btn-light">
                                    <input type="radio" name="color" value="btn btn-light"> Light
                                    </label>
                                 </div>
                              </div>
                           </div>
                           <div class="form-group row">
                              ...
                              <div class="col-lg-9">
                                 <div class="button-state grp-btns" data-toggle="buttons">
                                    <label class="btn btn-light active">
                        ...
                        <div class="form-group row">
                           ...
                           <div class="col-lg-9">
                              <div class="button-width grp-btns" data-toggle="buttons">
                                 <label class="btn btn-light active">
                        ...
                        <div class="custom-button-color">
                           ...
                           <div class="form-group row">
                              ...
                              <div class="col-lg-9">
                                 ...
                                 <label class="hint-label border-all">
                                 <input type="checkbox" name="border-all"> Use same color for all sides
                                 </label>
                              </div>
                           </div>
                        ...
                        <div class="form-group row" id="iconOption">
                           ...
                           <div class="col-lg-9">
                              <div class="include-icon grp-btns" data-toggle="buttons">
                                 <label class="btn btn-light active">
                                 <input type="radio" name="includeicon" value="1"><span class="fa fa-check"></span>
                                 </label>
                                 <label class="btn btn-light">
                                 <input type="radio" name="includeicon" value="0"><span class="fa fa-times"></span>
                                 </label>
                              </div>
                           </div>
                        </div>
                        <div class="form-group row toggle">
                           ...
                           <div class="col-lg-9">
                              <div class="fa-position grp-btns" data-toggle="buttons">
                                 <label class="btn btn-light active">
                                 <input type="radio" name="iconposition" value="left"><span class="fa fa-arrow-left"></span> Left
                                 </label>
                                 <label class="btn btn-light">
                                 <input type="radio" name="iconposition" value="right"> Right <span class="fa fa-arrow-right"></span>
                                 </label>
                              </div>
                           </div>
                        </div>
                        <div class="form-group row toggle">
                           ...
                           <div class="col-lg-9">
                              <div class="nav nav-pills mb-3" id="pills-tab-icon"><a class="btn btn-light" id="fontawesome-tab" data-toggle="pill" href="#pills-fontawesome" aria-controls="pills-fontawesome">Font Awesome</a><a class="btn btn-light" id="icoicon-tab" data-toggle="pill" href="#pills-icoicon" aria-controls="pills-icoicon">Ico Icons</a><a class="btn btn-light active" id="themify-tab" data-toggle="pill" href="#pills-themify" aria-controls="pills-themify">Themify</a></div>
                     ...
                     <div class="col-md-6 col-lg-5 order-1 order-xl-2" id="myScrollspy">
                        <div class="button-generator-bx custom-scrollbar">
                           <div class="box button-preview" data-spy="affix" data-offset-top="248">
                              ...
                              <div class="bg-transparent" id="result"><a class="btn btn-success btn-lg" href="#"><span class="fa fa-edit"></span> Button</a></div>
                           </div>
