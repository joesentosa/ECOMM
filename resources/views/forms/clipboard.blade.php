         ...
         <div class="card">
            ...
            <div class="card-body">
               <div class="clipboaard-container">
                  ...
                  <textarea class="form-control" id="clipboardExample2" rows="1" spellcheck="false">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has</textarea>
                  <div class="mt-3">
         ...
         <div class="card">
            ...
            <div class="card-body">
               <div class="clipboaard-container">
                  ...
                  <h6 class="border rounded card-body" id="clipboardExample3">
